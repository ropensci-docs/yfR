...
returns a dataframe with the financial data. All price data is measured
at the unit of the financial exchange. For example, price data for GM
...
- A customized function called
  [`yf_convert_to_wide()`](https://docs.ropensci.org/yfR/reference/yf_convert_to_wide.md)
...
(@joshuaulrich) and uses one of its functions
