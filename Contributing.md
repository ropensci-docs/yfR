...
contributing to the codebase of \`yfR.
...
Conduct](https://docs.ropensci.org/yfR/CODE_OF_CONDUCT.md). By
...
it](https://ropensci.github.io/yfR/authors.html).

### Report a bug 🐛

If you’ve found a bug using the package, please report it by creating an
[issue on GitHub](https://github.com/ropensci/yfR/issues/new) so we can
...
[This website](https://ropensci.github.io/yfR) is generated with
...
issue](https://github.com/ropensci/yfR/issues/new) and we can point you
...
1.  Go to `R/` directory in the [code
    repository](https://github.com/ropensci/yfR).
...
list](https://github.com/ropensci/yfR/issues) and leave a comment on the
...
1.  Fork [this repo](https://github.com/ropensci/yfR) and clone it to
